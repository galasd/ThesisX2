...
@Service
public class UserService implements FilterableCrudService<UserEntity> {
    ...
    @Override
    public UserEntity save(UserEntity currentUser, UserEntity entity) {
    ...
    @Override
    @Transactional
    public void delete(UserEntity currentUser, UserEntity userToDelete) {
    ...
    private void throwIfDeletingSelf(UserEntity currentUser, UserEntity user) {
        if (currentUser.equals(user)) {
            throw new UserFriendlyDataException(DELETING_SELF_NOT_PERMITTED);
        }
    }

    private void throwIfUserLocked(UserEntity entity) {
    ...
    @Override
    public UserEntity createNew(UserEntity currentUser) {
